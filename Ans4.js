Que4: Consider the two functions below. Will they both return the same thing? Why or why not?
...
Ans4: Surprisingly, these two functions will not return the same thing. Rather:
...
Reason:Not only is this surprising, but what makes this particularly gnarly is that foo2() returns undefined without any error being thrown.
